...
├───────────┼───────┼───────────────┼───────┼────────┼────────┤
│ alr       │     2 │ emc2, ti-gerr │   729 │  11201 │  43765 │
│ myndbash  │     3 │ bridge, dots  │  3378 │ 195370 │ 473875 │
└───────────┴───────┴───────────────┴───────┴────────┴────────┘
...
├─────────┼───────────────┼──────────┼───────┼────────┼────────┼──────────────────────┤
│ .config │ myndbash/dots │ 95.0 MiB │  3009 │ 180966 │ 416076 │ /home/myndbash/.confi│
│ emc2    │ alr/emc2      │  6.6 MiB │   672 │   9229 │  35852 │ /home/myndbash/emc2  │
└─────────┴───────────────┴──────────┴───────┴────────┴────────┴──────────────────────┘
...
├──────────┼─────────────┼─────────┼───────────┼──────────────────┤
│ e8de4387 │ claude-code │ 2.1.234 │     1m38s │ /home/myndbash   │
└──────────┴─────────────┴─────────┴───────────┴──────────────────┘
`
...
describe("parseDaemonStatus", () => {
  ...
  test("reads every table", () => {
    ...
    expect(status.workspaces[0]).toMatchObject({ workspace: "alr", repos: 2, nodes: 11201 })

    expect(status.repos).toHaveLength(2)
    expect(status.repos[1]).toMatchObject({ repo: "emc2", workspace: "alr/emc2", files: 672, edges: 35852 })
